...
/*Notify the main process about the reason of a possible unexpected shut down*/
...
process.on('message', function (message) {
  ...
  */
  ...
  /*
    The logic below will set all 'context' arguments in 2 lists,
  ...
  */
  var fork_arguments_names  = 'require,';
